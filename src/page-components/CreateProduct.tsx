            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-gray-500 bg-[#f4f5f8]">
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input type="checkbox" id="tax" className="rounded text-[#3b35d6]" />
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" defaultChecked className="rounded text-[#3b35d6]" />
                        Online Store
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" className="rounded text-[#3b35d6]" />
                        Shop App
                      </div>
                    </div>
                  </div>
