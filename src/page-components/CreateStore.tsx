    ...
    <div className="flex bg-gray-50 min-h-screen">
      ...
      <main className="flex-1 pb-20 lg:pb-0">
        <div className="p-4 md:p-6 max-w-5xl mx-auto">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex">
                        ...
                        <input type="text" className="flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 focus:ring-cyan-500 focus:border-cyan-500" placeholder="acme-clothing" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-700">Description</label>
                      <textarea 
                        className="w-full h-32 p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-sm"
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-gray-500 bg-gray-50 h-32">
                        <UploadCloud size={32} className="text-gray-400 mb-2" />
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <select className="w-full p-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-cyan-500">
          ...
          <div className="mt-8 flex justify-end gap-3 border-t pt-6 border-gray-200">
            <Link href="/stores">
